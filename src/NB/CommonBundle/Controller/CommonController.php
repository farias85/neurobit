...
abstract class CommonController extends Controller {
    ...
    public function successRedirect($id = null) {
        return $this->get('nb.manager')->successRedirect($id, $this->getRouteShow(), $this->getRouteIndex());
    }
    ...
    /**
     * Propocionar el manager de la entidad, si lo tiene, sino con devolver nb.manager está bien, sino null.
     * @return Manager
     */
...
//        $func();
    ...
    public function isXmlHttpRequest() {
        return $this->get('nb.manager')->isXmlHttpRequest();
    }
    ...
    public function renderJson($data, $status = 200, $headers = array()) {
        return $this->get('nb.manager')->renderJson($data, $status, $headers);
    }

    /**
     * Devuelve un objeto del GenericLangRepository para las traducciones
     * @return \NB\CommonBundle\Service\GenericLangRepository|object
     */
    public function glr() {
        return $this->get('nb.glr');
    }
    ...
    public function serializeJSON($data) {
        return $this->get('nb.manager')->serializeJSON($data);
    }
}
