...
use NB\CommonBundle\Form\NomenclatureType;
...
abstract class NomenclatureController extends CommonController implements EntityNameExtension {
    ...
    public function getManager() {
        return $this->get('nb.nomenclature.manager');
    }
...
//        ];
    ...
    public function newAction(Request $request) {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $data['nbFullEntityName'] = $fullEntityName;
    ...
    private function newViewForInvalidData($data, $isValid = []) {
        ...
        $this->get('nb.entitysetter')->fromData($entity, $data);
    ...
    public function editAction(Request $request, $id) {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            $existe = $this->get('nb.entitysetter')->fromData($entity, $data);
